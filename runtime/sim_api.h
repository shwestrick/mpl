...
//Added Magic Operations to Add and Remove Non-Coherent Regions
#define SIM_CMD_ADD_INCOHERENT_REGION       15
#define SIM_CMD_REMOVE_INCOHERENT_REGION    16

//Added Instructions to Track Hop Count
#define SIM_CMD_RESET_HOP_COUNT             17
#define SIM_CMD_GET_HOP_COUNT               18
...
//Added Magic Operations to Add and Remove Non-Coherent Regions
#define SimAddIncoherentRegion(region_begin, region_end)        SimMagic2(SIM_CMD_ADD_INCOHERENT_REGION, region_begin, region_end)
#define SimRemoveIncoherentRegion(region_begin, region_end)     SimMagic2(SIM_CMD_REMOVE_INCOHERENT_REGION, region_begin, region_end)

//Added Magic Operations to Reset and Get Hop Count Tracker
